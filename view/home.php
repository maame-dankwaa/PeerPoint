<?php
  ...
  $title = "Home | Ashesi PeerPoint"; //title for header
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <p class="fst-italic">
              We've all been there. We've witnessed the sighs and cries. We know the struggle of finding extra materials to learn. Above all we understand what it means to provide inclusive and equitable quality education. The goals of the app a:
            </p>

            <ul>
              <li><i class="bi bi-check-circle"></i> To increase the number of students who pass their courses at Ashesi</li>
              <li><i class="bi bi-check-circle"></i> To eliminate the stress students go through to find their own resources</li>
              <li><i class="bi bi-check-circle"></i> To strengthen the sense of community amongst students</li>
            </ul>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Why Choose the Hub?</h3>
              <p>
              The Hub is designed to support Ashesi's learning goals and provide valuable resources for the community.
              </p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Curiosity & Skill</h4>
                    <p>Through the resources available here, students can be inquisitive and confident, have breadth of knowledge, and attain mastery in their chosen field(s).</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Students are able to apply critical thinking and quantitative reasoning to approach complex problems.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-images"></i>
                    <h4>Technological Competence</h4>
                    <p>Through interaction with the hub students become effective and flexible users of technology.</p>
                  </div>
                </div>
              </div>
            </div>
